...
ReactGA.initialize('UA-172950947-1');
    ...
    return (
      <React.Fragment>
        ...
        <Switch>
          ...
          <Route
            path="/blog/page1/are-you-behind-several-years-on-filing-your-taxes/"
            component={P2}
          />
          <Route
            path="/blog/page1/in-hiding-haunted-or-hunted-tax-terror-and-how-to-fix-it/"
            component={P3}
          />
          <Route path="/blog/page1/the-tax-gap-and-how-it-relates-to-you/" component={P4} />
          <Route
            path="/blog/page1/everything-you-need-to-know-about-canadas-carbon-tax/"
            component={P5}
          />
          <Route
            path="/blog/page1/who-to-hire-to-solve-your-tax-problem-3-things-to-look-for/"
            component={P6}
          />
          ...
          <Route
            path="/blog/page1/overcoming-stigma-and-shame-around-the-topic-of-taxes/"
            component={P9}
          />
          ...
          <Route
            path="/blog/page2/spring-maybe-bank-account-might-still-winter-frozen-cra/"
            component={P7Page2}
          />
          ...
          <Route
            path="/blog/page3/hidden-meaning-behind-cra-notice-assessment/"
            component={P1Page3}
          />
          <Route path="/blog/page3/tax-tips-airbnb-owners-uber-drivers/" component={P2Page3} />
          <Route
            path="/blog/page3/voluntary-disclosure-filing-rules-change-10-days/"
            component={P3Page3}
          />
          ...
          <Route
            path="/blog/page3/tax-changes-small-business-proposed-liberals-good-thing/"
            component={P6Page3}
          />
          <Route path="/blog/page3/divorce-and-taxes/" component={P7Page3} />
          <Route
            path="/blog/page3/not-filing-taxes-will-ineligible-just-credit/"
            component={P8Page3}
          />
          <Route
            path="/blog/page3/new-rules-leveling-playing-liberals-taking-aim-voluntary-disclosures/"
            component={P9Page3}
          />
          {/*Blog Page 4*/}
          ...
          <Route
            path="/blog/page4/cra-targeting-contractors-construction-industry/"
            component={P3Page4}
          />
          <Route
            path="/blog/page4/cra-aggressively-going-taxpayers-whats-next/"
            component={P4Page4}
          />
          <Route
            path="/blog/page4/new-cra-rules-regarding-voluntary-disclosure-program-start-january-1-2018/"
            component={P5Page4}
          />
          <Route
            path="/blog/page4/changes-voluntary-disclosure-program-coming-time-now-file/"
            component={P6Page4}
          />
          ...
          <Route
            path="/blog/page4/revenue-canadas-criminal-investigations-program/"
            component={P9Page4}
          />
          ...
          <Route
            path="/blog/page5/underground-framer-comes-clean-with-cra-as-much-as-100k/"
            component={P2Page5}
          />
          <Route
            path="/blog/page5/when-you-get-a-notice-of-assessment-that-you-dont-want-to-get/"
            component={P3Page5}
          />
          <Route
            path="/blog/page5/whitby-resident-jailed-and-fined-for-tax-evasion/"
            component={P4Page5}
          />
