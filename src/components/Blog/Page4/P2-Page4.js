...
export default function P2Page4() {
    return (
            ...
            <BlogPages date="August 9, 2017" title="Business Taxes And Accounting And Doing It Yourself... Does It Make Sense?" subtitle="By: Fraser Simpson" mainPara=
            {
            <div>
            <p>
