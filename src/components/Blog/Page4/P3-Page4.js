...
export default function P3Page4() {
    return (
            ...
            <BlogPages date="August 9, 2017" title="CRA Targeting Contractors In The Construction Industry" subtitle="By: Fraser Simpson" mainPara=
            {
            <div>
            <span>Special audits have confirmed the pervasiveness of tax evaders in the construction industry, and the CRA is cracking down</span>
            <p>The Canada Revenue Agency’s continuing campaign against the underground economy has come to roost in small-town Canada, where special audits have confirmed the pervasiveness of tax evaders in the construction industry. This is all part of a CRA focus on the underground economy that has been a priority for several years, ever since the construction sector was identified as being of concern for unreported income
            <br/><br/>
            ...
            <br/><br/>
            If you have not filed your taxes in a few years or longer let us help you.</p>
            <p>
            <span>Contact</span>
            <br/>
