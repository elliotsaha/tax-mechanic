...
export default function P4Page4() {
    return (
            ...
            <img className="GradientS1Comp" src="/img/Blog/TopImage.png" width="100%" alt="OurTeam"/>
                <div className="S1TextContainer">
                    <div className="S1Text">
                        <span style={{whiteSpace: "normal"}}>CRA Aggressively Going After Taxpayers... What's Next?</span>
            ...
            <BlogPages date="July 17, 2017" title="CRA Aggressively Going After Taxpayers... What's Next?" subtitle="By: Fraser Simpson" mainPara=
            {
            <div>
            <p>
