...
export default function P4Page5() {
    return (
            ...
            <BlogPages date="March 20, 2017" title="Whitby Resident Jailed And Fined For Tax Evasion" subtitle="By: Fraser Simpson" mainPara=
            {
            <div>
            <p>
