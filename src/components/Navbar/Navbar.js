...
export default function Navbar() {
    return (
        ...
        <ReactBootStrap.Navbar.Collapse id="basic-navbar-nav">
            ...
            <ReactBootStrap.Nav.Link><Link to="/" className="NavbarLink"><span>HOME</span></Link></ReactBootStrap.Nav.Link>
            <ReactBootStrap.Nav.Link><Link to="/ourteam" className="NavbarLink"><span>OUR TEAM</span></Link></ReactBootStrap.Nav.Link> 
            
            <ReactBootStrap.NavDropdown className="Dropdown" title={<span className="NavbarLink">SERVICES</span>}  id="basic-nav-dropdown">
            ...
            <ReactBootStrap.Nav.Link><Link to="/blog" className="NavbarLink"><span>BLOG</span></Link></ReactBootStrap.Nav.Link>
            <ReactBootStrap.Nav.Link><Link to="ebook" className="NavbarLink"><span>E-BOOK</span></Link></ReactBootStrap.Nav.Link>
            <ReactBootStrap.Nav.Link><Link to="testimonials" className="NavbarLink"><span>TESTIMONIALS</span></Link></ReactBootStrap.Nav.Link>
            <ReactBootStrap.Nav.Link><Link to="contact" className="NavbarLink"><span>CONTACT US</span></Link></ReactBootStrap.Nav.Link>
            </ReactBootStrap.Nav>
